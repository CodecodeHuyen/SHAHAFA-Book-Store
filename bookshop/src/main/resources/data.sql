...
VALUES
    (130000.00,'2018-10-16',120,450,4,'James Clear','ISBN-AH-001','Atomic Habits',
    ...
    (150000.00,'2016-01-05',60,500,4,'Cal Newport','ISBN-DW-001','Deep Work',
    ...
    (28000.00,'2002-03-01',150,150,1,'Lê Linh','ISBN-TDDV-001','Thần Đồng Đất Việt Tập 1',
    ...
    (28000.00,'2002-06-01',140,150,1,'Lê Linh','ISBN-TDDV-002','Thần Đồng Đất Việt Tập 2',
    ...
    (115000.00,'2010-02-01',70,400,3,'Robin Sharma','ISBN-LD-001','Nhà Lãnh Đạo Không Chức Danh',
    ...
    (145000.00,'2013-12-01',80,400,4,'Koga Fumitake, Kishimi Ichiro','ISBN-DBG-001','Dám Bị Ghét',
    ...
    (98000.00,'2016-09-10',65,300,5,'Tetsuko Kuroyanagi','ISBN-TTC-002',
    ...
    (32000.00,'1994-01-01',200,180,1,'Aoyama Gosho','ISBN-CONAN-001','Conan Tập 1',
    ...
    (32000.00,'1994-05-01',190,180,1,'Aoyama Gosho','ISBN-CONAN-002','Conan Tập 2',
    ...
    (100000.00,'2012-08-01',60,350,2,'Phạm Lữ Ân','ISBN-100N-001',
    ...
    (90000.00,'2013-05-01',70,300,2,'Lưu Đồng','ISBN-TTX-001',
    ...
    (125000.00,'1997-01-01',65,400,3,'Robin Sharma','ISBN-FERR-001',
    ...
    (140000.00,'2014-03-01',50,450,4,'Cao Minh','ISBN-TTBD-001',
    ...
    (95000.00,'2013-07-01',80,350,3,'Robin Sharma','ISBN-DN-001',
     'Đời Ngắn Đừng Ngủ Dài',
     'https://i.pinimg.com/736x/89/26/4d/89264d2be019994beb82bae841bacbb1.jpg',
     'Sống trọn vẹn từng ngày.','ACTIVE'),

    (89000.00,'2018-09-10',75,280,5,'Nguyễn Nhật Ánh','ISBN-HVTT-001',
    ...
    (35000.00,'2019-07-04',160,200,1,'Tatsuya Endo','ISBN-SPY-001',
     'Spy X Family Tập 1',
    ...
    (35000.00,'2019-10-04',150,200,1,'Tatsuya Endo','ISBN-SPY-002',
     'Spy X Family Tập 2',
    ...
    (220000.00,'2011-10-25',40,700,4,'Daniel Kahneman','ISBN-TDNC-EN-001',
    ...
    (45000.00,'2020-01-01',200,200,5,'Nhiều tác giả','ISBN-COLOR-001',
    ...
    (250000.00,'2019-03-15',55,900,5,'Nhiều tác giả','ISBN-EN-001',
